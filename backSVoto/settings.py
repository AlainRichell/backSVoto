"""
Django settings for backSVoto project.
...
SECRET_KEY = 'django-insecure-kd=dsv2xic69p+skr6j*2!bpq#nmf-vm)i+shqb)n6m%eaxbq3'
...
WSGI_APPLICATION = 'backSVoto.wsgi.application'
